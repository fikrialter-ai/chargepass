...
export function MobileShell({ children, activeNav = "Home", onNavChange }) {
  return (
    <div className="mx-auto flex h-[844px] w-[min(390px,calc(100vw-16px))] max-w-[390px] flex-col overflow-hidden rounded-[44px] border-[10px] border-[#050816] bg-cloud shadow-soft ring-4 ring-slate-900/10">
